...
/**
 * cd_dot - used for changing directory
 *
 * @datash: used to hold info
 *
 * Return: 0
 */
...
/**
 * cd_to - accepts comand from the user
 *
 * @datash: ued for holding info
 * Return: 0
 */
...
/**
 * cd_previous - used to change directory
 *
 * @datash: used to hold theinfo
 * Return: 0
 */
...
/**
 * cd_to_home - used to change dir
 *
 * @datash: used to hold the relevant data information
 * Return: 0
 */
